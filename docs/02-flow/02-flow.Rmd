---
title: "2: Inputs, outputs, and rendering functions"
subtitle: "Relating inputs to rendering functions to outputs & build on one app over the chapter"
output: 
  learnr::tutorial:
    progressive: true
    allow_skip: true
...
```{r ex2-solution, include = FALSE, eval = FALSE}
library(shiny)
library(ggplot2)
load("movies.RData")
...
```{r ex-2-2a-solution, include = FALSE, eval = FALSE}
library(shiny)
library(ggplot2)
...
```{r, ex-2-2b-solution, echo = FALSE, eval = FALSE}
library(shiny)
library(dplyr)
...
server <- function(input, output, session) {
  ...
  output$moviestable <- renderDataTable({
    movies_from_selected_studios <- movies %>%
      ...
      select(title:studio)
    datatable(data = movies_from_selected_studios, 
                  options = list(pageLength = 10), 
                  rownames = FALSE)
  })
...
```{r, ex-2-2c-solution, include = FALSE}
library(shiny)
library(ggplot2)
load("movies.RData")
...
```{r ex-2-2d-solution, include = FALSE}
library(shiny)
library(dplyr)
library(ggplot2)
load("movies.RData")
...
```{r where-summary, eval = FALSE, echo = TRUE}
mainPanel(
  # Show scatterplot
  plotOutput(outputId = "scatterplot"), 
  # Show data table
...
```{r summary_table, eval = FALSE, echo = TRUE}
...
```{r missing-solution, include = FALSE}
library(shiny)
library(ggplot2)
load("movies.RData")
...
```{r render-text, eval = FALSE, echo = TRUE}
library(shiny)
library(ggplot2)
load("movies.RData")
...
```{r render-text-solution, include = FALSE}
library(shiny)
library(ggplot2)
load("movies.RData")
...
In the following four exercises you'll get to work with other interactive graphics and output functions!
...
```{r hovering, eval = FALSE, echo = TRUE}
# Load packages
library(shiny)
library(tidyverse)
...
```{r hover-solution, include = FALSE}
# Load packages
library(shiny)
library(tidyverse)
...
```{r text-outputs, eval = FALSE, echo = TRUE}
library(shiny)
library(dplyr)
library(ggplot2)
load("movies.RData")
...
```{r text-outputs-solution, include = FALSE}
library(shiny)
library(dplyr)
library(ggplot2)
load("movies.RData")
...
```{r download-solution, include = FALSE}
library(shiny)
library(dplyr)
library(readr)
load("movies.RData")
