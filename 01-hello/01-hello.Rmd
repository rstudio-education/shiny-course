...
- In the `ui`:
  ...
  - Use `"z"` as the `inputId`` can be whatever you like,`.
...
Try entering some text and observe how the text is displayed back to you after a short pause.
...
question("Which of the following is false?",
  answer('`[1]` should be `"Input some text here:"`',
         message = "Take a look at the app, what text is shown to the user above the text input area?"),
  answer('`[2]` should be `textOutput`', 
         message = "Check out the Shiny cheatsheet for pairs of input and output functions"),
  answer('`[3]` should be `"custom_text"`', correct = TRUE),
  answer('`[4]` should be `"custom_text"`',
         message = "What is the ID of the input that should be rendered?"),
  allow_retry = TRUE
)
```
