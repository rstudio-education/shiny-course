...
server <- function(input, output, session) {
  ...
  output$moviestable <- DT::renderDataTable({
    ...
    datatable(data = movies %>% select(input$selected_var), 
...
```{r reactive-solution, include = FALSE}
library(shiny)
library(dplyr)
library(readr)
load("movies.RData")
...
server <- function(input, output, session) {
  ...
  output$moviestable <- DT::renderDataTable({
    req(input$selected_var)
    datatable(data = movies_selected(), 
              options = list(pageLength = 10), 
              rownames = FALSE)
  })
...
```{r debug-reactives, eval = FALSE, echo = TRUE}
library(shiny)
library(ggplot2)
library(dplyr)
library(tools)
...
```{r debug-reactives-solution, echo = FALSE, eval = FALSE}
library(shiny)
library(ggplot2)
library(dplyr)
library(tools)
...
```{r inconsistencies, eval = FALSE, echo = TRUE}
library(shiny)
library(ggplot2)
library(dplyr)
load("movies.RData")
...
```{r inconsistencies-solution, include = FALSE}
library(shiny)
library(ggplot2)
library(dplyr)
load("movies.RData")
...
```{r isolate, eval = FALSE, echo = TRUE}
library(shiny)
library(ggplot2)
library(tools)
load("movies.RData")
...
```{r isolate-solution, include = FALSE}
library(shiny)
library(ggplot2)
library(tools)
load("movies.RData")
...
```{r eventReactive, eval = FALSE, echo = TRUE}
library(shiny)
library(ggplot2)
library(tools)
load("movies.RData")
...
```{r eventReactive-solution, include = FALSE, eval = FALSE}
library(shiny)
library(ggplot2)
library(tools)
load("movies.RData")
...
```{r trigger, eval = FALSE, echo = TRUE}
library(shiny)
load("movies.RData")
...
```{r trigger-solution, echo = FALSE, eval = FALSE}
library(shiny)
load("movies.RData")
