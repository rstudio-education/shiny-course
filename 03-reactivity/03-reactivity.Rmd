...
```{r mc-parents-children, echo=FALSE}
...
```{r 3-1-reactive, echo = TRUE, eval = FALSE}
# Load packages ----------------------------------------------------------------
...
```{r 3-1-reactive-solution, include = FALSE}
# Load packages ----------------------------------------------------------------
...
- However reactive expressions are lazy, they only get executed when their input changes. 
  - This means that even if you call a reactive expression multiple times in your app, it will only re-execute when its inputs change.
...
```{r 3-2a-debug-reactives, eval = FALSE, echo = TRUE}
# Load packages ----------------------------------------------------------------
...
```{r 3-2a-debug-reactives-solution, echo = FALSE, eval = FALSE}
# Load packages ----------------------------------------------------------------
...
```{r 3-2b-inconsistencies, eval = FALSE, echo = TRUE}
# Load packages ----------------------------------------------------------------
...
```{r 3-2b-inconsistencies-solution, include = FALSE}
# Load packages ----------------------------------------------------------------
...
### Test understanding of the `reactiveValues()` function 
...
```{r 3-4a-isolate, eval = FALSE, echo = TRUE}
# Load packages ----------------------------------------------------------------
...
```{r 3-4a-isolate-solution, include = FALSE}
# Load packages ----------------------------------------------------------------
...
```{r 3-4b-eventReactive, eval = FALSE, echo = TRUE}
# Load packages ----------------------------------------------------------------
...
```{r 3-4b-eventReactive-solution, include = FALSE, eval = FALSE}
# Load packages ----------------------------------------------------------------
...
```{r 3-4c-trigger, eval = FALSE, echo = TRUE}
# Load packages ----------------------------------------------------------------
...
```{r 3-4c-trigger-solution, echo = FALSE, eval = FALSE}
# Load packages ----------------------------------------------------------------
...
```{r 3-5-mult3, echo = TRUE, eval = FALSE}
# Load packages ----------------------------------------------------------------
...
```{r 3-5-mult3-solution, echo = FALSE, eval = FALSE}
# Load packages ----------------------------------------------------------------
